...
from models import create_db_tables, APIKey, User
...
async def audit_log_middleware(request: Request, call_next):
    ...
    logging.info(f"{request.method} {request.url.path} user={user_identifier or 'unknown'} status={response.status_code}")
    return response
